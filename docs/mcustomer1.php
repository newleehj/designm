...
<style type="text/css">
.wrapformb {width:90%; margin:100px auto;}
...
.form-box .receive-btn input{width:30%;padding:15px 0;background:#585858;color:#fff;border:0; margin:50px 0 0 130px; border-radius:5px;}
