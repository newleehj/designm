...
<main class="introD">
    ...
    <section class="introwrapD">
        <figure class="box1D">
            <img src="<?php echo G5_URL ?>/image/intro1.png" alt="인트로-사람손 일러스트" class="boximgD">
        ...
        <figure class="box2D">
            <img src="<?php echo G5_URL ?>/image/intro2.png" alt="인트로-사람손 일러스트" class="boximgD">
            <figcaption class="boxtextD">제품디자인, 산업디자인, 기구설계, 시각디자인, 패키지 디자인 등 시제품 개발과 
                양산 컨설팅을 주 업무로하며, 다양한 제품 개발 경험과 지식으로 최고의 솔루션을 제시합니다.  
            </figcaption>
        </figure>
        <figure class="box3D">
            <img src="<?php echo G5_URL ?>/image/intro3.png" alt="인트로-사람손 일러스트" class="boximgD">
        ...
        <figure class="mapD">
            ...
            <img src="<?php echo G5_URL ?>/image/map.png" alt="맑음 지도" class="mapDimg">
